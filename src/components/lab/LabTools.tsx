...
export function LabTools() {
  return (
    <div className="space-y-6">
      ...
      <ToolSection
        id="spectroscope-bands"
        title="Spectroscope Band Matcher"
        description="Tick observed absorption bands to rank candidate species"
        iconPath={ICON_PATHS.spectrum}
        accent="rose"
      >
        <SpectroscopeBandMatcher />
      </ToolSection>

      <ToolSection
        id="uv-fluorescence"
        title="UV Fluorescence Lookup"
        description="Match observed long-wave / short-wave UV reactions to gem species"
        iconPath={ICON_PATHS.uv}
        accent="rose"
      >
